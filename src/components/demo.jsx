...
export const Main = () => {
    ...
    const ProjectAnimation = useRef()
      ...
      useEffect(() => {
    init(AnimatedTextOne.current, { showCursor: false, strings: [ 'Student.','Full Stack Developer.', 'Database Designer.' , 'App Developer.' ] })
    },[]);
    useEffect(() => {
        init(MainText.current, { showCursor: false, strings: [ 'Computer Science.'] })
        },[]);
        useEffect(() => {
            init(ProjectAnimation.current, { showCursor: false, strings: [ 'Full Stack Developer.','App Developer.','Database designer.'] })
            },[]);
   ...
   <div className="grid lg:grid-cols-2  md:grid-cols-2 xs:grid-cols-1">
        <div className="MainHeading mt-6 text-4xl font-headline tracking-tight font-extrabold" data-aos="fade-right">
            <h1 className="Hello">HELLO,</h1>
            <h1 className="Name">I am <span className="FirstText">S</span>
   ...
   <div className="grid lg:grid-cols-2 md:grid-cols-2 sm:grid-cols-1 xs:grid-cols-1">
      <div className="ProjectArea" data-aos="fade-up-left">
          <img src={ProjectImage} alt="ProjectIOmage" className="ProjectImage"></img>
      </div>
      <div className="Project" data-aos="fade-up-right">
          <h1 className="ProjectsTitle">Projects</h1>
          <p className="SubProject">
 Check out my various projects and applications where I have worked as <span className="ProjectAnimatedText" ref={ProjectAnimation}></span>
          </p>
          <NavLink exact to='/Project'>
          <button type="button" className=" ProjectButton text-white bg-gradient-to-r from-purple-500 to-pink-500 hover:bg-gradient-to-l focus:ring-4 focus:ring-purple-200 dark:focus:ring-purple-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2">Projects</button>
          </NavLink>
